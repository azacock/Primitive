...
public class ContainerCraftingSpot extends Container
{
    ...
    public ContainerCraftingSpot(InventoryPlayer p_i1808_1_, World p_i1808_2_, int p_i1808_3_, int p_i1808_4_, int p_i1808_5_)
    {
    ...
    {
        return this.worldObj.getBlock(this.posX, this.posY, this.posZ) != Primitive.crafting_spot ? false : p_75145_1_.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
