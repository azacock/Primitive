...
public class GuiCraftingSpot extends GuiContainer
{
    ...
    public GuiCraftingSpot(InventoryPlayer p_i46397_1_, World p_i46397_2_, int p_i46397_3_, int p_i46397_4_, int p_i46397_5_)
    {
