...
public final class RenderPathSlab implements ISimpleBlockRenderingHandler {
	@Override
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block b, int modelID, RenderBlocks renderer) {
		Tessellator tess = Tessellator.instance;
		renderer.setRenderBounds(0f, -1f / 16f, 0f, 1f, 7f / 16f, 1f);
		if ((world.getBlockMetadata(x, y, z) & 8) == 8)
			renderer.uvRotateTop = 1;
		renderer.renderStandardBlockWithAmbientOcclusion(b, x, y, z, 1.25f, 1.25f, 1.25f);
